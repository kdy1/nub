...
| Project and config | PM identity/major override rules, source-scoped npmrc/auth/TLS/proxies, ordered manifests, install-shape digests, workspace glob matching | Complete settings session, nub.jsonc consumers, Yarn/Bun adapters, workspace discovery and filters |
