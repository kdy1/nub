...
| Resolution | npm semver oracle, version/publish-age selection, source identities, platforms, graph traversal and optional/peer passes, direct override matching and nested-object flattening, locked reuse and advisory preferences, catalog expansion, package extensions and direct dependency seeding | Full dependency resolution, peer contexts/conflicts, ancestor overrides, Git/generator execution |
