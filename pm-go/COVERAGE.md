...
| Lockfiles | npm v1/v2/v3/versionless reader and v3 writer; canonical hoist layout; native npm fixture round trips; pnpm peer/patch/alias keys, checksums, typed YAML document selection and v9+ graph reader | pnpm/nub.lock writer, Bun, Yarn adapters; frozen/drift orchestration; unchanged-file policy |
