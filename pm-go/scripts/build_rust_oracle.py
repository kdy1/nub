...
with subprocess.Popen(
    ...
    for line in process.stdout:
        ...
        if name in {"aube_lockfile", "aube_manifest", "aube_util", "aube_resolver", "serde_json", "node_semver"}:
...
if set(artifacts) != {"aube_lockfile", "aube_manifest", "aube_util", "aube_resolver", "serde_json", "node_semver"}:
